...
<div class="pagination">
    <ul>
        ...
        <?php if ($previous_page !== FALSE): ?>
            <li><a href="<?php echo HTML::chars($page -> url($previous_page)) ?>"><?php echo __('Предыдущая') ?></a></li>
        <?php endif ?>
        ...
        <?php if ($next_page !== FALSE): ?>
            <li><a href="<?php echo HTML::chars($page -> url($next_page)) ?>"><?php echo __('Следующая') ?></a></li>
        <?php endif ?>
