        ...
        <div class="span5 offset3 well">
            <form class="form-horizontal" action="" method="post">
                ...
                <div class="control-group pull-right clearfix">
                    ...
                    <div class="controls">
						<input type="text" name="login" id="alogin" placeholder="Type your email or username"/>
					</div>
                </div>
                ...
                <div class="control-group pull-right">
                    ...
                    <div class="controls">
						<input type="password" name="password" id="apassword"  placeholder="Type your password"/>
					</div>
                </div>
