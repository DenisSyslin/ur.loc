...
<div id="container">
    <div class="container">
        <div class="row title">
	        <div class="span12">
                <h1 class="pull-left"><?php echo __('Список новостей') ?></h1>
                <a class="btn btn-success pull-right"
                   href="<?php echo URL::site('/admin/news/new') ?>"><i class="icon-plus"></i> <?php echo __('Новая') ?></a>
	        </div>
        </div>
                    ...
                    <tbody>
				        <?php if (!empty($items)) : ?>
	                        ...
	                        <tr>
	                            ...
	                            <td class="actions">
		                            <div class="btn-group">
		                                <a class="btn" href="<?php echo URL::site('admin/news/delete/' . $item[ 'id' ]) ?>">
											<i class="icon-remove"></i> <?php echo __('Удалить') ?>
										</a>
		                                <a class="btn btn-primary" href="<?php echo URL::site('admin/news/edit/' . $item[ 'id' ]) ?>">
					    ...
					    <?php else: ?>
		                    <tr>
		                        <td colspan="6"><?php echo __('Нет новостей') ?></td>
		                    </tr>
					    <?php endif; ?>
                    </tbody>
