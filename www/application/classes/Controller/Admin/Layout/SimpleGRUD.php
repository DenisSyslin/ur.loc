<?php defined('SYSPATH') or die('No direct script access.');
	...
	/**
	 * Контроллер GRUD для простых задач
	 *
	 * @name        Controller_Admin_Layout_SimpleGRUD
	 * @category    Admin
	 * @subcategory Layout
	 * @author      Суслин Денис 2015г. <programist1985@gmail.com>
	 */
	 
	abstract class Controller_Admin_Layout_SimpleGRUD extends Controller_Admin_Layout_Secure {
    ...
    /* End of file SimpleGRUD.php */
    /* Location: ./application/classes/Controller/Admin/Layout/SimpleGRUD.php */
